...
| 2026-09-16 | Chapitres 0.4 | Martin précise plusieurs niveaux par planète et demande des images aussi réalistes que possible : trois niveaux par planète, cartes entre niveaux, rangs plafonnés selon l’avancement ; anciennes sauvegardes préservées. Cartographies locales Solar System Scope / INOVE CC BY 4.0, projection sphérique et éclairage, accueil et plateau solidaires de la rotation. | Éviter une planète expédiée en une seule salle et renforcer l’immersion ; 59 tests et simulation de 20 runs (10 victoires). Voir docs/CHAPITRES_2026-09-16.md et public/CREDITS_PLANETES.md. |

| 2026-09-16 | Hélios 0.5 | Martin demande davantage de fluidité, un univers cohérent avec les planètes réalistes, une histoire et le décor sur tout l’écran. Cristaux facettés et cadre verre, animations positionnelles sans pauses décoratives, projection planétaire en worker, HUD transparent ; rupture du réseau Hélios et journal facultatif. | Planètes et règles conservées ; détails et validations dans docs/HELIOS_2026-09-16.md. |

| 2026-09-16 | Performance 0.5.1 | Martin ressent encore moins de 30 fps. Reproduction Chromium DPR 3 : intervalle médian 50 ms. Décor séparé en calque composé, vignette en cache, suppression des flous sur le jeu et des dessins synchrones de survol, canvas plafonné à DPR 2 / 2 Mpx avec coordonnées corrigées. | Traiter la cadence réelle plutôt que raccourcir les animations ; voir docs/PERFORMANCE_2026-09-16.md et tools/perf.mjs. |

| 2026-09-16 | Transition 0.5.2 | Martin demande un petit écran de chargement avec histoire avant chaque nouvelle planète pour masquer l’apparition tardive du décor. Approche orbitale de quatre secondes, démarrage anticipé possible seulement une fois prêt ; préparation du globe et des lunes avant révélation. | Pas de récit répété entre niveaux ou à la reprise ; les erreurs proposent un réessai et les caches échoués sont purgés. |
