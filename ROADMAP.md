...
- [ ] (mineur, sonde finale) En finale, une spéciale isolée qui explose affiche « +10 » (sa propre bille) sous le « +100 » de sa zone : deux textes de la même salve, à fusionner (même famille que le point suivant).
- [ ] (mineur, capture naissance) Quand une bombe s'enchaîne sur le tap, « Étincelle ! » et « BOOM ! » se superposent au même endroit (deux mots de la même salve) : décaler ou fusionner les mots d'un même coup.
