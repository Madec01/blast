...
- **Juice (obligatoire)** : texte flottant `+XP` à chaque salve (police grasse blanche cernée d'encre, monte et s'efface) ; mots de combo sur la case tapée selon la taille (4 « Étincelle ! », 6 « Stellaire ! », 8 « Supernova ! », 10+ « BIG BANG ! » — Carrousel cosmique) en très gros, avec rebond élastique et rotation ±6°, jamais hors du canvas ; deux textes d'une même salve ne se superposent jamais : les +XP émis à moins de 350 ms et 1,5 case l'un de l'autre s'additionnent en un seul texte, un mot de combo qui en recouvre un autre encore plein passe dessous (le plus petit bouge) ; confettis multicolores (rectangles qui tournent, gravité) + étoiles à 4 branches à chaque destruction ; anneau d'onde de choc sur les explosions ; le plateau entier fait un petit « squash » élastique à l'atterrissage des billes et à la fin d'une rotation ; screenshake proportionnel ; les billes rebondissent (restitution 0,25) et se déforment légèrement (squash vertical 10 %) à l'impact.
